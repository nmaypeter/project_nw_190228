from SeedSelection_NGSCS import *
                ...
                for prod_setting2 in prod_setting2_seq:
                    ...
                    for bud in range(begin_budget, total_budget + 1):
                        ...
                        for sample_count in range(sample_number):
                            print("@ mnscsic seed selection @ data_set_name = " + data_set_name + ", wpiwp = " + str(wpiwp) +
                        ...
                        for pps in pps_seq:
                            ...
                            for sample_count, sample_seed_set in enumerate(seed_set_sequence):
                                print("@ mngscsic evaluation @ data_set_name = " + data_set_name + ", wpiwp = " + str(wpiwp) +
                            ...
                            path1 = "result/mnscswic_pps" + str(pps) + "_wpiwp" * wpiwp
                            if not os.path.isdir(path1):
                                os.mkdir(path1)
                            path = "result/mnscswic_pps" + str(pps) + "_wpiwp" * wpiwp + "/" + data_set_name + "_" + product_name
                            if not os.path.isdir(path):
                                os.mkdir(path)
                            fw = open(path + "/" + "b" + str(bud) + "_i" + str(sample_number) + ".txt", 'w')
                            fw.write("mngscsic, pp_strategy = " + str(pps) + ", total_budget = " + str(bud) + ", wpiwp = " + str(wpiwp) + "\n" +
