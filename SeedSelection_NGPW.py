...
if __name__ == "__main__":
    ...
    ssngpw = SeedSelectionNGPW(graph_dict, seed_cost_dict, product_list, total_budget, monte_carlo)
    ...
    prod_wei_list = ssngpw.getProductWeight()
    celf_sequence = ssngpw.generateCelfSequence(prod_wei_list)
    mep_celf = [-1, 0.0]
