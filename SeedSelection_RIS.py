...
class SeedSelectionNG:
    ...
    def generateCelfSequence(self):
        ...
        diff_ss = DiffusionRR(self.graph_dict, self.seed_cost_dict, self.product_list, self.total_budget, self.monte)
...
if __name__ == "__main__":
    ...
    diff = DiffusionRR(graph_dict, seed_cost_dict, product_list, total_budget, monte_carlo)
    rr_graph_dict = diff.generateRRGraph()
    diff = DiffusionRR(rr_graph_dict, seed_cost_dict, product_list, total_budget, monte_carlo)
